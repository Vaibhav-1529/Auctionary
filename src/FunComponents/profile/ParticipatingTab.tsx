...
async function ParticipatingTab() {
  ...
  if (error) {
    ...
    return <p className="text-red-500">Error loading your bidding activity.</p>;
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold text-gray-900">My Bidding Activity</h3>
      ...
      <Suspense fallback={<div className="rounded-2xl border-2 border-dashed p-12 text-center bg-gray-50/50">
