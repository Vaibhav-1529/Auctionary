  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-370 mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-primary-foreground/70 mb-6">
            ...
            <div className="flex justify-center gap-4 text-primary-foreground">
          ...
          <div>
            ...
            <div className="flex items-center border border-primary-foreground/40 rounded-md overflow-hidden mb-6">
              <input
                type="email"
                placeholder="Email Address"
                className="bg-transparent px-4 py-2 text-sm w-full placeholder:text-primary-foreground/60 focus:outline-none"
              />
            ...
            <div className="bg-card rounded-md p-2 inline-flex gap-2">
              <img
      ...
      <div className="border-t border-primary-foreground/20">
        <div className="max-w-370 mx-auto px-6 py-4 flex flex-col md:flex-row justify-between text-xs text-primary-foreground/70 gap-3">
